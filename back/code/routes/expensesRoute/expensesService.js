...
exports.findById = async (expenseId) => {
  ...
  if(expense[0]!==undefined)expense[0].upload_date = formatDateTime(expense[0].upload_date);
  if(expense[0]!==undefined)expense[0].payment_date = formatDateTime(expense[0].payment_date);
  return expense[0];
};
