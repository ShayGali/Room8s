...
public class RegisterHandler extends AsyncTask<Void, Void, JSONObject> {
    ...
    public RegisterHandler(WeakReference<MainActivity> activity, WeakReference<TextView> userNameTextView, WeakReference<TextView> emailTextView, WeakReference<TextView> passwordTextView) {
